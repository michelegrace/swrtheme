...
if (!class_exists('MultiPostThumbnails')) {
	...
	class MultiPostThumbnails {
		...
		public function enqueue_admin_scripts( $hook ) {
			...
			$template_url = get_bloginfo('template_url') . '/lib/multi-post-thumbnails-admin.js';
			wp_enqueue_script("featured-image-custom",  $template_url, array('jquery'));
			wp_enqueue_script( "mpt-featured-image-modal", get_bloginfo('template_url') . '/lib/media-modal.js', array( 'jquery', 'media-models', 'set-post-thumbnail' ) );
		}
