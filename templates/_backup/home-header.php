<section class="home-hero" style="background-color:<?php the_field('background_color'); ?>70">
    <div class="container">
...
<a href="<?php echo get_field('link_to_read_current_issue'); ?>">
                    <img class="enlarge-hover aligncenter img-responsive" src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" />
</a>
                <?php endif; ?>
            </div>
